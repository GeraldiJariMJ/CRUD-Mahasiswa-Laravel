      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start rtl:justify-end">
          ...
          <a href="https://flowbite.com" class="flex ms-2 md:me-24">
            ...
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Dashboard {{ Auth::user()->role }}</span>
          </a>
        ...
        <div class="flex items-center">
            <div class="flex items-center ms-3">
                <label for="toggle" class="inline-flex items-center cursor-pointer">
                    ...
                    <script>
                      // Cek apakah dark mode diaktifkan berdasarkan localStorage
                      if (localStorage.getItem('dark-mode') === 'enabled') {
                          document.querySelector('html').classList.add('dark');
                          document.querySelector('#toggle').checked = true; // Sesuaikan checkbox
                      }
                      ...
                      checkbox.addEventListener('click', function () {
                          if (checkbox.checked) {
                              ...
                              localStorage.setItem('dark-mode', 'enabled'); // Simpan status dark mode
                          } else {
                              html.classList.remove('dark');
                              localStorage.setItem('dark-mode', 'disabled'); // Simpan status light mode
                          }
                      });
                  </script>
