                ...
                <tbody>
                  ...
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                     ...
                     <td class="px-6 py-4 text-right">
                         <a href="{{ url('admin/dosen/edit/'.$value->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                         ||
                         <form action="{{ url('admin/dosen/destroy/'.$value->id) }}">
                           @method('delete')
